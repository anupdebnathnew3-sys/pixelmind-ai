...
const PROMPT_STYLES = [
  ...
  },
  {
    ...
    label: 'Creative',
    icon: '✦',
    desc: '150–200 words · artistic',
    color: '#8B5CF6',
    instruction: 'Generate a CREATIVE, ARTISTIC prompt of EXACTLY 150–200 words. Use imaginative and evocative language. Include storytelling elements, unique visual metaphors, cinematic atmosphere, and artistic style references. Make it visually striking and unconventional. Count your words carefully — the output MUST be between 150 and 200 words, no more, no less.',
  },
  {
    id: 'commercial',
    label: 'Commercial',
    icon: '◉',
    desc: '150–200 words · stock-ready',
    color: '#F59E0B',
    instruction: 'Generate a COMMERCIAL STOCK PHOTOGRAPHY prompt of EXACTLY 150–200 words. Focus on professional composition, commercial appeal, marketable subject framing, clean execution, and stock-ready aesthetics. Include lighting quality and professional photography terms suitable for stock marketplaces. Count your words carefully — the output MUST be between 150 and 200 words, no more, no less.',
  },
  {
    id: 'ultra',
    label: 'Ultra Detail',
